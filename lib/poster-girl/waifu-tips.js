...
(function () {
    ...
    if (referrer.href !== '' && referrer.hostname != 'lilei.blog' ||'pro90rushb.github.io') {
        var referrer = document.createElement('a');
        referrer.href = document.referrer;
        ...
        if (window.location.href == 'https://lilei.blog/' ||'https://pro90rushb.github.io/') { //如果是主页
...
function initLive2d() {
    $('.hide-button').fadeOut(0).on('click', () => {
        setCookie("live2dhidden", "yes", 0.1),
